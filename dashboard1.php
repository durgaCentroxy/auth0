...
<body>
    <div class="container-fluid">
        <div class="container">
            <nav class="navbar navbar-expand-lg navbar-light">
                <a class="navbar-brand" href="#"><img src="img/centroxy-logo-black.png" alt="" style="width: 50px; height: 50px;"></a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item active">
                            <a href="dashboard2.php" class="nav-link">silicon</a>
                        </li>
                        <li class="nav-item active">
    ...
    <div class="container-fluid">
        <div class="container">
            <h3 style="border-bottom: 2px solid black; display: inline-block;">Details:</h3>
            <ul class="list-unstyled">
                <li>PHP Developers : 5</li>
                <li>Mendix Developers : 8</li>
                <li>Hardoop Developers : 6</li>
                <li>JS Developers : 7</li>
            </ul>
        </div>
    </div>
    <!-- Optional JavaScript -->
